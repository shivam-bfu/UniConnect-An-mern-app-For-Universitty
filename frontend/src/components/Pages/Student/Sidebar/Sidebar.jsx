...
import "./Sidebar.css";
import fbImage from "../../../../assets/fb.jpg"; // Ensure this path is correct
  ...
  useEffect(() => {
    const fetchUserData = async () => {
      try {
        ...
        console.log("Fetched User:", result); // Log the fetched user data

        if (response.ok) {
          setUser(result.user); // Ensure that you set the correct key
        } else {
      ...
      <div className="parent  ml-12">
        <div className="card">
          ...
          <div className="content">
            ...
            <p className="text-black">{user?.guId} </p>
            <p className="text-black">
   {user?.guId && 2024 - parseInt(user.guId.split("-")[1], 10) > 1 ? "(Alumni)" : ""}
</p>
